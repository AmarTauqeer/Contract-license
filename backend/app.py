...
from resources.licenses import *
...
from resources.software_license import *
...
app.config.update({
    'APISPEC_SPEC': APISpec(
        title='Automatic Contracting Tool Contracts (license) API Specification',
...
api.add_resource(GetSoftwareLicense, '/software/')
docs.register(GetSoftwareLicense)

api.add_resource(SoftwareUpdate, '/software/update/')
docs.register(SoftwareUpdate)

api.add_resource(SoftwareCreate, '/software/create/')
docs.register(SoftwareCreate)

api.add_resource(SoftwareById,
                 '/software/<string:softwareID>/')
docs.register(SoftwareById)

api.add_resource(SoftwareDeleteById,
                 '/software/delete/<string:softwareID>/')
docs.register(SoftwareDeleteById)
