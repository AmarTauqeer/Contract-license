...
class HelperContract:
    ...
    def function_map(self, name):
        ...
        mapfunc = {
            ...
            "get_all_software": self.get_all_software,
            ...
            "get_software_by_id": self.get_software_by_id,
    ...
    def which_query(self, purpose=None, dataRequester=None, additionalData=None, contractID=None,
                    ...
                    termTypeID=None, signatureID=None, companyID=None, softwareID=None
                    ):
        ...
        if additionalData == "softwareLicenses":
            return dict({"map": "get_all_software"})
        ...
        if additionalData == "softwareID" and softwareID is not None:
            return dict({"map": "get_software_by_id", "arg": softwareID})
    ...
    def select_query_gdb(self, purpose=None, dataRequester=None, additionalData=None, contractID=None,
                         ...
                         obligationID=None, termTypeID=None, signatureID=None, companyID=None, softwareID=None, turleformat=False):
        ...
        which_query_return = self.which_query(purpose, dataRequester, additionalData, contractID,
                                              ...
                                              termTypeID, signatureID, companyID, softwareID)
